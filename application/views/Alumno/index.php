	   ...
	   foreach ($alumnos as $fila) { 
	   	...
	   	?>
                    <tr>
						...
						<td><?= $fila->apellidos_alumno;?></td>
                        <td><?= $fila->matricula_alumno;?></td>
                        <td>
                        <a href="<?php echo base_url(); ?>index.php/Alumnos/VerAlumno/<?php echo $fila->id_alumno; ?> " 
                        	class="view" >
                     	...
                     	<a href="<?php echo base_url(); ?>index.php/Alumnos/confirmarEliminarAlumno/<?php echo $fila->id_alumno; ?>" class="delete" >
                     		<i class="material-icons" 
                     			data-toggle="tooltip" 
                     			title="Eliminar">&#xE872;
                     		</i>
